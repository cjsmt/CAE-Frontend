<template>
  <div>
    ...
    <el-row :gutter="5">
      <el-col :span="10">
        <div class="grid-content bg"><h3>训练进度</h3>
          <el-row :gutter="10">
            <el-col :span="16">
              ...
              <div class="grid-content-mini bg">
                <el-col :span="12">
                  <el-row>
                    <el-button type="success" @click="beginTraining"><el-icon><SwitchButton /></el-icon>开始训练</el-button>
                  </el-row>
                  <el-row>
                    <el-button type="danger" @click="dialogTableVisible1 = true"><el-icon><SwitchButton /></el-icon>终止训练</el-button>
                  </el-row>
                  <el-row>
                    <el-button type="primary" @click="updateProgress"><el-icon><RefreshRight /></el-icon>刷新进度</el-button>
                  </el-row>
                </el-col>
                  <el-dialog title="确定要终止训练吗？" v-model="dialogTableVisible1" width="30%">
                    <template #footer>
                      <span class="dialog-footer">
                        <el-button type="primary" @click="dialogTableVisible1 = false, this.$data.percentage = 0;">确认</el-button>
              ...
              <el-row :span="16">
                <div class="upload-item">
                  <el-upload class="upload-demo"
                             ...
                             :file-list="DataFile">
                    <el-button size="large" type="primary"><el-icon><Upload /></el-icon>选择数据文件</el-button>
                  </el-upload>
                </div>
                <div class="download-item">
                    <el-button size="large" type="warning" @click="downloadModel"><el-icon><Download /></el-icon>下载生成模型</el-button>
                </div>
              </el-row>
            </div>
          </el-row>
          ...
          <el-table :data="ReserveData" :show-header="true" style="width: 100%" max-height="500">
            ...
            <el-table-column align="right">
              <template #default="scope">
                <el-button type="primary" size="mini" @click="handleEdit(scope.row)">查看
                </el-button>
              </template>
            </el-table-column>
          </el-table>
          <el-dialog title="训练记录" v-model="dialogTableVisible2" width="30%">
            <template #footer>
                      <span class="dialog-footer">
                        <el-button type="primary" @click="dialogTableVisible2 = false, this.$data.percentage = 0;">确认</el-button>
